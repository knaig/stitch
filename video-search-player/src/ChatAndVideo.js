  ...
  return (                
    <div className="App">
      ...
      <div className="content-section">
        <h1>Vote For Trump</h1>
        <p>Engage with Our Campaign</p>  

        {/* Example Images */}
        <div className="image-gallery">
          <img src={`${process.env.PUBLIC_URL}/images/image1.webp`} alt="Trump 1"/>
          <img src={`${process.env.PUBLIC_URL}/images/image2.jpg`} alt="Trump 2"/>
        </div>        
      </div>
      {showChat && (
